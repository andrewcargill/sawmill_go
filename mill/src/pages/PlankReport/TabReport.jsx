...
import { AppBar, Paper, Tabs, Tab, Box, Container, Grid, Card, Table, TableHead, TableRow, TableCell, TableContainer, TableBody } from '@mui/material';
                        ...
                        <Paper >
                            <Container >
                                <Grid container xs={12} spacing={1} paddingBottom={2} >
                                    <Grid item xs={6}>
                                        <img src={props.plank.image1} alt="Image 1" style={{ width: '100%', maxWidth: '150px' }} />
                                    </Grid>
                                    <Grid item xs={6}>
                                        <img src={props.plank.image2} alt="Image 2" style={{ width: '100%', maxWidth: '150px' }} />
                                    </Grid>
                                </Grid>
                            </Container>
                        </Paper>
...
const TabPanel = (props) => {
    ...
    return (
        <div
            ...
            {...other}
        >
            {value === index && <Box p={3}>{React.cloneElement(children, { treeData })}</Box>}
        </div>
    );
};
...
const TabReport = (props) => {
    ...
    return (
        <Container>
            <AppBar position="static" style={{ backgroundColor: theme.palette.white.main }}>
